                                        ...
                                        <table dir="rtl" cellpadding="0" cellspacing="0" border="0" width="100%" align="center" class="max-div-width2" style="margin: 0 auto;">
                                            <tr>
                                                <td style="text-align: center;">
                                                    ...
                                                    <div class="remove-max-width" dir="ltr" style="width: 100%;max-width: <?php echo htmlentities($_POST['main4-img-width-desktop']); ?>px;display: inline-block;vertical-align: top; float: left;">
